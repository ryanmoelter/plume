...
- The chat list is a `LazyVStack` that once froze the app while scrolling. If it does again, **`docs/chat-list-hang.md`** has the history, the DEBUG scroll harness, and the order to bisect in.
